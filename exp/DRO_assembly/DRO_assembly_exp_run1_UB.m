...
options.log_file = 'assembly_cutplane.log';
...
options.LP_params.LogFile = 'assembly_gurobi_LP.log';

options.global_params = struct;
options.global_params.OutputFlag = 1;
options.global_params.LogToConsole = 0;
options.global_params.LogFile = 'assembly_gurobi_MILP.log';

options.rescue = struct;
options.rescue.save_file = 'assembly_savefile.mat';
options.rescue.save_interval = 100;

reduce_cuts_thres = [20000; 5000; 5000; 2000; 1000; 500; 200; 100];
...
for step_id = 1:step_no
    ...
    save('exp/DRO_assembly/exp_rst_UB.mat', 'LSIP_LB_list', ...
