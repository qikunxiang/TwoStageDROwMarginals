...
load('exp/DRO_network/exp_invcdf.mat');
load('exp/DRO_network/exp_rst_UB.mat', 'stage1_decision_cell', ...
    'stage1_multipliers_cell', 'coup_meas_cell');

% compute the inverse cdf of the marginal distributions
marginv = @(i, u)(DRO_supply_chain_network_marginv(i, u, customer_no, ...
    mixtrnorm_invcdf_cell, failure_prob));
...
for step_id = 1:step_no
    ...
    save('exp/DRO_network/exp_rst_LB.mat', ...
        'LB_samps_cell', 'LB_errbar', ...
