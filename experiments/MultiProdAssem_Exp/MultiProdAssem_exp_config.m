function CONFIG = MultiProdAssem_exp_config()
% Place to store global configurations of the two-stage distributionally robust multi-product assembly problem with marginal
% constraints
% Output:
...
% path to save files
CONFIG.SAVEPATH = [CONFIG.SAVEPATH_ROOT, 'DRO/MultProdAssem_Exp/'];

% path to log files
CONFIG.LOGPATH = [CONFIG.LOGPATH_ROOT, 'DRO/MultProdAssem_Exp/'];
