...
for i = 1:4
    for j = 1:4
        ...
        if i == j
            ...
            set(gca, 'YLim', [samp_min(plot_index_list(i)) - 0.02, samp_max(plot_index_list(i)) + 0.02]);
        end
    
        set(gca, 'XLim', [samp_min(plot_index_list(j)) - 0.02, samp_max(plot_index_list(j)) + 0.02]);
        set(gca, 'XTickLabel', []);
        set(gca, 'YTickLabel', []);
