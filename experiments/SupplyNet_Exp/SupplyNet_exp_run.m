...
LSIP_options = struct;
LSIP_options.dual_feasibility_tolerance = 1e-6;
...
NewVar_options.init_extrapolation = 10;
NewVar_options.proj_ub = 500 * ones(problem.unc_num, 1);
...
Iter_options.phase2.iter_num = 2e3;
...
tolerance = 0.5;
OT_tolerance = 1e-3 / problem.unc_num;
wc_samp_num = 1e6;
...
RS = RandStream('mrg32k3a', 'Seed', 5555);
